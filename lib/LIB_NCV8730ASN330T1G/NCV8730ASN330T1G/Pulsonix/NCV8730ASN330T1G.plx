...
//12790160/494016/2.50/5/4/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "NCV8730ASN330T1G" (originalName "NCV8730ASN330T1G")
	...
	(compDef "NCV8730ASN330T1G" (originalName "NCV8730ASN330T1G") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "NCV8730ASN330T1G"))
		...
		(attr "Manufacturer_Part_Number" "NCV8730ASN330T1G")
		(attr "Mouser Part Number" "863-NCV8730ASN330T1G")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/onsemi/NCV8730ASN330T1G?qs=GedFDFLaBXG9IOwczGXdzg%3D%3D")
		(attr "Arrow Part Number" "NCV8730ASN330T1G")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/ncv8730asn330t1g/on-semiconductor?region=nac")
		(attr "Description" "LDO Regulator Pos 3.3V 0.15A Automotive 5-Pin TSOP T/R")
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/distributors/Datasheets_SAMA/2df29e4e0191e431728827d4926d2a47.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "NCV8730ASN330T1G.stp")
