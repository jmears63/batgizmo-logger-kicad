...
(library Library_1
	...
	(compDef "MAX6070AAUT18+T" (originalName "MAX6070AAUT18+T") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "FILTER") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "6" (pinName "OUTF") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "OUTS") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://datasheets.maximintegrated.com/en/ds/MAX6070-MAX6071.pdf")
		(attr "Height" "1.45 mm")
	)
